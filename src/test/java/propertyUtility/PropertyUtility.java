...
// Facem o metoda care sa scoata valoarea unei propietati pe baza de cheie - valoare
    public String getPropertyValue(String key){
        return properties.getProperty(key);
    }
// Facem o metoda care sa scoata toate cheile si valoriile intr-un hashmap
